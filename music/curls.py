...
urlpatterns = [
    ...
    url(r'^add_stop_words/$', cviews.add_stop_words, name='add_stop_words'),
    url(r'^upload_stop_words/$', cviews.upload_stop_words, name='upload_stop_words'),
    url(r'^delete_stop_words/(?P<stopwords_id>[0-9]+)/$', cviews.delete_stop_words, name='delete_stop_words'),
